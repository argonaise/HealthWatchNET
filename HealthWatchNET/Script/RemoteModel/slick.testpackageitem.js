(function ($) {
    ...
    */
    function RemoteModelPackageItem() {
        // private
        var PAGESIZE = 200;
        var data = { length: 0 };
        var searchstr = "";
        ...
        function ensureData(from, to) {
            ...
            var url = baseurl + "/?query=" + searchstr + "&offset=" + (fromPage * PAGESIZE) + "&to=" + PAGESIZE + "&t=" + t;
        ...
        function setPackageSearch(str) {
            baseurl = "/Data/TestPackageItem";
            searchstr = str;
            clear();
        }


        function setItemSearch(str) {
            baseurl = "/Data/TestItem";
            searchstr = str;
            clear();
        }

        function setPresetSearch(sp_no) {
            baseurl = "/Data/TestPresetItem";
            searchstr = sp_no;
            clear();
        }
    ...
    $.extend(true, window, { Slick: { Data: { RemoteModelPackageItem: RemoteModelPackageItem}} });
})(jQuery);