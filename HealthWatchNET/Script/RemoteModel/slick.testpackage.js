    ...
    */
    function RemoteModelPackage() {
        ...
        function ensureData(from, to) {
            ...
            var url = "/Data/TestPackage/?query=" + searchstr + "&offset=" + (fromPage * PAGESIZE) + "&to=" + PAGESIZE + "&t=" + t;
    ...
    $.extend(true, window, { Slick: { Data: { RemoteModelPackage: RemoteModelPackage}} });
})(jQuery);